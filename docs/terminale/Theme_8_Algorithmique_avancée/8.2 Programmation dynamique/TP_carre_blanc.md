...
!!! example Exercice
    Écrire la fonction ```pgcb_memo```, identique à la fonction ```pgcb``` mais qui mémoïse ses résultats. On pourra se servir d'une **fonction englobante** commel'exmeple avec Fibonacci.
