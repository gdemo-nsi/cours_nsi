...
Un paradigme de programmation pourrait se définir comme une _philosophie_ dans la manière de programmer : c'est une manière d'aborder le problème à résoudre. Une fois cette décision prise, des outils spécifiques au paradigme choisi sont utilisés. 
...
!!! info "Métaphore"
    ...
    - Le premier pourra décider d'utiliser de la colle : il assemblera les morceaux de bois en les collant.  
          - &rarr; Son outils principal sera le pistolet à colle.
  
    - Le deuxième pourra décider de visser les morceaux de bois entre eux.
          - &rarr; Son outil principal sera une visseuse.  
  
    - Le troisième pourra décider de faire de l'assemblage par [tenons et mortaises](https://www.fraise-defonceuse.fr/tenon-mortaise-defonceuse/).  
          - &rarr; Son outil principal sera une défonceuse.
...
!!! note "Résumé paradigmes"
    <table>
        <tr>
            <th></th>
            <th style="text-align:center; font-size: 1.3em;">Impérative</th>
            <th style="text-align:center; font-size: 1.3em;">Orientée Objet</th>
            <th style="text-align:center; font-size: 1.3em;">Fonctionnelle</th>
        </tr>
        <tr>
            <th style="text-align:center;">Principe général</th>
            <td align="left">On explique au programme comment faire à l'aide d' une suite d’instructions exécutées pas à pas.</td>
            <td align="left">On représente le problème sous forme d’objets qui interagissent.</td>
            <td align="left">On dit au programme quoi calculer plutôt que comment le faire.</td>
        </tr>
        <tr>
            <th style="text-align:center;">Organisation du code</th>
            <td align="left">Programme découpé en procédures / fonctions qui manipulent des variables.</td>
            <td align="left">Programme organisé autour de classes et d’objets (instances de classes).</td>
            <td align="left">Programme contenant uniquement des définitions et appels de fonctions</td>
        </tr>
        <tr>
            <th style="text-align:center;">Langages utilisés</th>
            <td align="left">Python, C</td>
            <td align="left">Java, C++, Python</td>
            <td align="left">OCaml, <i>Python partiellement</i></td>
        </tr>
        <tr>
            <th style="text-align:center;">Comparaisons</th>
            <td align="left">Recette de cuisine (étape par étape)</td>
            <td align="left">Construction en Lego (objets qui s’assemblent et interagissent)</td>
            <td align="left">Suite de formules mathématiques</td>
        </tr>
    </table>
...
!!! example "Exercice 1"
    ...
    :writing_hand: Créer une classe ```Point``` permettant de créer un objet ```A``` , dont on récupèrera l'abscisse par la variable ```A.x``` et l'ordonnée par ```A.y```.
    
    [Lien vers console python pour réaliser les exercices.](https://capytale2.ac-paris.fr/web/c/db17-11588680/mln){: target="_blank"}
...
!!! warning "Les mots clés à retenir :heart:"

    <br>
    <table width="100%">
        <tr>
            <th style="font-size: 1.3em; text-align:center;"></th>
            <th style="font-size: 1.3em; text-align:center;">Classe</th>
        ...
        <tr>
            ...
            <td style="text-align:center;">Similaire à un plan de construction d'un objet</td>
