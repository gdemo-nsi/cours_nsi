...
!!! tip Petit Jeu
    ...
    :arrow_right: Saurez-vous le trouver ?
...
La recherche *naïve* (élément par élément) est naturellement de complexité linéaire. Nous allons voir que la méthode dichotomique est plus efficace.
 ...
 :computer: A vous de programmer :
:arrow_right: [intro_dichotomie.pdf](intro_dichotomie.pdf)
...
> :computer: A vous de programmer la version récursive avec le slicing.
...
!!! question Visualisation grâce à python tutor 
    :arrow_right: [Lien vers visualisation.](https://tinyurl.com/4mp75wyf)

    <!-- https://pythontutor.com/visualize.html#code=def%20dichotomie_rec%28tab,%20val%29%3A%0A%20%20%20%20if%20len%28tab%29%20%3D%3D%200%3A%0A%20%20%20%20%20%20%20%20return%20False%0A%20%20%20%20i_centre%20%3D%20len%28tab%29%20//%202%0A%20%20%20%20if%20tab%5Bi_centre%5D%20%3D%3D%20val%3A%0A%20%20%20%20%20%20%20%20return%20True%0A%20%20%20%20if%20tab%5Bi_centre%5D%20%3C%20val%3A%0A%20%20%20%20%20%20%20%20return%20dichotomie_rec%28tab%5Bi_centre%20%2B%201%3A%5D,%20val%29%20%23%20%0A%20%20%20%20else%3A%0A%20%20%20%20%20%20%20%20return%20dichotomie_rec%28tab%5B%3Ai_centre%5D,%20val%29%20%20%23%20%0A%0Atab%20%3D%20%5B1,%205,%207,%209,%2012,%2013%5D%0Adichotomie_rec%28tab,%206%29%0Adichotomie_rec%28tab,%2012%29&cumulative=false&heapPrimitives=nevernest&mode=edit&origin=opt-frontend.js&py=311&rawInputLstJSON=%5B%5D&textReferences=false) -->
...
>  :computer: A vous de programmer l'algorithme d'exponentiation rapide.
...
!!! example "Exercices"
    ...
    > :computer: Recréer le graphique ci-dessus, qui compare les temps d'exécution des deux fonctions ```puissance``` et ```puissance_mod```.
...
!!! tip "Principe de l'interclassement"
    ...
    - on part d'une liste vide ```List_totale```
...
!!! example  exercice()
    ...
    :arrow_right: [intro_interclassement.pdf](intro_interclassement.pdf)
...
!!! tip **Principe de l'algorithme du tri fusion : :heart:**
...
!!! abstract "Algorithme de tri fusion (*merge sort*) :heart: :heart:
...
!!! question Tri fusion déroulement
    :arrow_right: [Lien gif](gif_fusion.gif)


Il est aussi conseillé d'observer l'évolution de l'algorithme grâce à PythonTutor :

!!! question Visualisation python tutor
    :arrow_right: [Lien vers Visualisation](https://tinyurl.com/3d3zv77m)
...
Pour finir, un site permetant de comparer visuellement les différents tris : [Comparaison tris](https://www.toptal.com/developers/sorting-algorithms)
